...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Daftar Order Menunggu Pengantaran</h1>
    <div class="row">
        ...
        <div class="card-header py-3">
            <div class="row">
                ...
                <div class="col align-self-start">
                    <a href="<?php echo base_url('ordertransaction/all'); ?>" style="margin-top:5px;" class="  btn btn-primary font-weight-bold"><i class="fas fa-sync-alt"></i> Seluruh Order</a>
                ...
                <div class="col align-self-end">
                    <div class="btn-group float-right">
                        <form action="<?= base_url('OrderTransaction/exportproses') ?>" method="POST">
                            ...
                            <tbody>
                                ...
                                foreach ($query->getResult() as $key => $row) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn">
                                                <a href="<?php echo base_url('ordertransaction/proses/' . $row->id_order); ?>" class="btn btn-sm btn-warning" onclick="return confirm('Apakah Anda yakin Order ini Telah Diantar?');">
                                                    Telah Diantar ?
